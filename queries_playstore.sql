...
-- 3. Count the number of apps in each category, e.g. "Family | 1972". category,count in beginning give two columns
SELECT category, COUNT(*) FROM analytics GROUP BY category;

-- 4. Find the top 5 most-reviewed apps and the number of reviews for each.
--most, greatest showing as DESC
...
-- 15. Find the app that has the highest proportion of reviews to min_installs, among apps that have been installed at least 100,000 times. Display the name of the appalong with the number of reviews, the min_installs, and the proportion.
